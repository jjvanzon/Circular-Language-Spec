...
|  Object Get ß  | (Object Get à) |
| (Object Set à) |  Object Set ß  |
...
|     Use As Class ß     |   Use Reference As Class ß   |   (Class Get à)   |
|     (Class Set à)      |        (Class Set à)         |    Class Set ß    |
|                        |                              |                   |
|  __Object-Class Get__  |   __Reference-Class Get__    |                   |
...
|   Object-Class Get ß   |    Reference-Class Get ß     |                   |
|     (Class Set à)      |        (Class Set à)         |                   |
...
|    (Use As Class à)   |   Reference Class Get ß   |  Object-Class Get ß   |
|      Class Set ß      |      (Object Set à)       |    (Object Set à)     |
|                       |                           |                       |
|     __Value Get__     |       __Value Set__       |                       |
...
|      Value Get ß      |       (Value Get à)       |                       |
|     (Value Set à)     |        Value Set ß        |                       |
|                       |                           |                       |
|   __Clone (2) Get__   |     __Clone (2) Set__     |                       |
...
|    Clone (2) Get ß    |     (Clone (2) Get à)     |                       |
|   (Clone (2) Set à)   |      Clone (2) Set ß      |                       |
|                       |                           |                       |
|        __New__        |                           |                       |
...
|  Use As Class __(≈ Get Object)__ ß   |
|              Class Set à             |
|                                      |
