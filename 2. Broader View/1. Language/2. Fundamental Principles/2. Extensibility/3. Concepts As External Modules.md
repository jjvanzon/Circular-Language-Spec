...
Everywhere these variables change, an Apply procedure is called that either adds or removes the ID or Reference Count. The changes of to the dependecies take place in __RelationClass__, but the Attribute is *added* to __*Class__*. This creates no futher complications.
