...
|:------------------:|:------------------:|:-----------------:|
|  __Public Required__   | __Protected Required__ | __Public Required__  |
|     __Object Set__     |     __Object Set__     |    __Object Get__    |
|                        |                        |                      |
...
|  __Private Required__  |  __Friend Required__   | __Private Required__ |
|     __Object Set__     |     __Object Set__     |    __Object Get__    |
|                        |                        |                      |
...
| __Protected Required__ |  __Friend Required__   | __Public Required__  |
|     __Object Get__     |     __Object Get__     |    __Class Set__     |
|                        |                        |                      |
...
|  __Public Required__   |  __Private Required__  | __Friend Required__  |
|    __Use As Class__    |      __Class Set__     |    __Value Set__     |
|                        |                        |                      |
...
|  __Public Required__   |  __Public Required__   |  *(as opposed to)*   |
|   __Clone (2) Get__    |        __New__         |    __Public New__    |
|                        |                        |                      |
...
|  __Friend Required__   |  __Public Required__   | __Public Required__  |
|       __Execute__      |     __Object Get__     |   __Use As Class__   |
|                        |                        |                      |
| ![](images/2.%20Imported%20Parameter%20Concepts.024.png) | | | 
|  __Public Required__   |                        |                      |
|    __Use As Class__    |                        |                      |
|                        |                        |                      |
| (might be a better notation,  | | |
| since it is more likely to be | | |
| used for plain command calls) | | |
