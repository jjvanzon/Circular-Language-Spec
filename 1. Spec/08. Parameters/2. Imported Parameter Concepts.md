...
| Protected Required <br> Object Get | Friend Required <br> Object Get | Public Required <br> Class Set | 
| | | |
...
| Public Required <br> Clone (2) Get | Public Required New | *(as opposed to)* <br> Public New |
| | | |
...
|Public Required <br> Use As Class <br> <br> (might be a better notation, since it is more likely to be used for plain command calls) | | |
