...
Each sub idea could work more or less independently of the others. __Monitor__ does its bit, __Keyboard__ does its bit. It might be the super idea that would tie the sub ideas together. Meaning: the computer could make the link between monitor, keyboard, mouse and printer. The super idea might combine the sub ideas and might manage the communication between the sub ideas.
