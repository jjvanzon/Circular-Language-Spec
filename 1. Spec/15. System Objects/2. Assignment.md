...
| __Get Value à__ <br> __Set Value ß__ |
...
| __Get Object à__ <br> __Set Object ß__ | 
| *Tries to let one symbol point to the object indicated by the other.*<br> *So attempts to yield over the object aspect.* |
| *The result might be:* |
| ![](images/2.%20Assignment.006.png) |
| |
| __Class Assignment__ |
| ![](images/2.%20Assignment.007.png) |
| __Use As Class (≈ Get Object) à__ <br> __Set Class ß__ |
...
| __Get Reference-Bound Class à__  <br> __Set Object ß__ |
| *The result might be:* |
| ![](images/2.%20Assignment.013.png) |
| *The object reference on the right may now point to the class of the object reference on the left.* |
| |
| __Object-Bound Class to Object Assignment__ |
| ![](images/2.%20Assignment.014.png) | 
| __Get Object-Bound Class à__ <br> __Set Object  ß__ |
| *The result might be:* |
| ![](images/2.%20Assignment.015.png) |
| *The object reference on the right may now point to the class of the object on the left.* |
...
| __Get Reference-Bound Class ß__ <br> __Set Class à__  |
| |
| ![](images/2.%20Assignment.017.png) |
| __Get Object-Bound Class ß__  <br> __Set Class à__ |
