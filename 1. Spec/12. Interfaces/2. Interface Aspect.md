...
|:-------------------------------------------:|
|   __Use As Interface ß  (~= Object Get)__   |
|             __Interface Set à__             |
...
|        __Use Reference As Interface ß (~= Reference Get)__         |
|   __Interface Set à  (~= Set Interface to Other Related Item)__    |
|                                                                    |
|            ![](images/2.%20Interface%20Aspect.008.png)             |
|        __Use Reference As Interface ß (~= Reference Get)__         |
| __Interface Set à  (~= Set Interface to Other Related List Item)__ |
|                                                                    |
...
|      __Use As Interface ß  (~= Use Reference As Interface)__       |
|   __Interface Set à  (~= Set Interface to Other Related Item)__    |
|                                                                    |
...
|           __Use As Interface ß__            |      __Use Reference As Interface ß__       |            __(Interface Get à)__            |
|           __(Interface Set à)__             |           __(Interface Set à)__             |             __Interface Set ß__             |
|                                             |                                             |                                             |
|          __Object-Interface Get__           |         __Reference-Interface Get__         |                                             |
| ![](images/2.%20Interface%20Aspect.028.png) | ![](images/2.%20Interface%20Aspect.029.png) |                                             |
|         __Object-Interface Get ß__          |        __Reference-Interface Get ß__        |                                             |
|            __(Interface Set à)__            |            __(Interface Set à)__            |                                             |
|                                             |                                             |                                             |
|          __Interface Merged Get__           |          __Interface Merged Set__           |                                             |
| ![](images/2.%20Interface%20Aspect.030.png) | ![](images/2.%20Interface%20Aspect.031.png) |                                             |
|         __Interface Merged Get ß__          |              __(Value Get à)__              |                                             |
|              __(Value Set à)__              |         __Interface Merged Set ß__          |                                             |
