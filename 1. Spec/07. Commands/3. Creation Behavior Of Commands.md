...
![](3.%20Creation%20Behavior%20Of%20Commands.001.png)

\- Parameters / public contents are present

![](3.%20Creation%20Behavior%20Of%20Commands.002.png)

\- Private contents are *not* created
(private objects, clauses and command calls)

![](3.%20Creation%20Behavior%20Of%20Commands.003.png)

\- Reference and Object Out parameters are already assigned

![](3.%20Creation%20Behavior%20Of%20Commands.004.png)

\- Value parameter assignments refer to their sources and targets

![](3.%20Creation%20Behavior%20Of%20Commands.005.png)

Right before a command executes:

\- Value In parameter assignments are executed

![](3.%20Creation%20Behavior%20Of%20Commands.006.png)
...
![](3.%20Creation%20Behavior%20Of%20Commands.009.png)

\- *Sub*-commands’ Reference and Object Out parameters are assigned
(targets copied from the parent command’s definition)
(The definition of the parent command is not shown in the diagram.)

![](3.%20Creation%20Behavior%20Of%20Commands.010.png)

\- Sub-commands’ Value parameter assignments refer to their sources and targets
(copied from the parent command’s definition)

![](3.%20Creation%20Behavior%20Of%20Commands.011.png)

Then the command runs:

![](3.%20Creation%20Behavior%20Of%20Commands.012.png)
...
![](3.%20Creation%20Behavior%20Of%20Commands.013.png)

\- Value Out parameter assignments are executed

![](3.%20Creation%20Behavior%20Of%20Commands.014.png)

\- Private contents are released
(private objects, clauses and command calls)

![](3.%20Creation%20Behavior%20Of%20Commands.015.png)
...
![](3.%20Creation%20Behavior%20Of%20Commands.016.png)
...
![](3.%20Creation%20Behavior%20Of%20Commands.017.png)
...
![](3.%20Creation%20Behavior%20Of%20Commands.018.png)

Their publics are created as soon as the parent command is created

![](3.%20Creation%20Behavior%20Of%20Commands.019.png)

but their privates are only created when the command call is about to be run.

![](3.%20Creation%20Behavior%20Of%20Commands.020.png)

Special creation behavior does *not* count for inactive command objects inside a parent command, that have a class redirection to a command definition.

![](3.%20Creation%20Behavior%20Of%20Commands.021.png)
...
![](3.%20Creation%20Behavior%20Of%20Commands.022.png)

Unlike its active form, which can not be referenced.

![](3.%20Creation%20Behavior%20Of%20Commands.023.png)

Therefore, it can also be *class* referenced by a call.

![](3.%20Creation%20Behavior%20Of%20Commands.024.png)
...
![](3.%20Creation%20Behavior%20Of%20Commands.025.png)

Creating its private contents, does not create a recursive creation or anything: the inactive call’s own private calls do not create *their* private contents, so there is no recursion there.

![](3.%20Creation%20Behavior%20Of%20Commands.026.png)
### **No Overhead of Command Creation**
...
![](3.%20Creation%20Behavior%20Of%20Commands.027.png)
...
![](3.%20Creation%20Behavior%20Of%20Commands.028.png)

Therefore, the private contents of calls inside a definition are *never* created.

![](3.%20Creation%20Behavior%20Of%20Commands.029.png)
...
![](3.%20Creation%20Behavior%20Of%20Commands.030.png)

Only the *definition* of the called command will show private contents.

![](3.%20Creation%20Behavior%20Of%20Commands.031.png)
...
![](3.%20Creation%20Behavior%20Of%20Commands.032.png)

But *calls inside* such a definition, only have their *public* contents are created again.

![](3.%20Creation%20Behavior%20Of%20Commands.033.png)
...
![](3.%20Creation%20Behavior%20Of%20Commands.034.png)
...
![](3.%20Creation%20Behavior%20Of%20Commands.035.png)
