...
*Relationship synchronization* might mean ensuring the integrity between the two counterparts of a relationship. For example, when a __Lid__ would be__ assigned__ to a __Jar__, the __Jar__ might__ also be assigned to the __Lid__.
