...
Dividing up into ideas can lead to *reusability* of ideas. For instance: the idea of a *button* is reusable. It can be used more than once. If a good button were programmed, other people may not need to program another button again. The same idea can be reused where another button is needed.
