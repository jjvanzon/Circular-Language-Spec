...
Hopefully this shed some light on the different situation that can occur when programming with *objects* and how they might be expressed inside the Circular language.
