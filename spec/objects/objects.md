...
So far the introduction to different situation that might occur when programming with *objects* and how they can be expressed inside the Circular language.
